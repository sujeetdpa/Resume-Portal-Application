...
public class HomeController {
    ...
    @PostMapping(value = "/user/add-details/{name}",params = "addLink")
    public ModelAndView addLink(@ModelAttribute User user){
        user.getLinks().add(new Link());
        ModelAndView mv;
        mv=new ModelAndView("user/registrationForm.html");
        mv.addObject("templates",resumeTemplateService.getTemplates());
        mv.addObject("user",user);
    ...
    @PostMapping(value = "/user/add-details/{name}",params = "removeLink")
    public ModelAndView removeLink(@ModelAttribute User user,HttpServletRequest req){
        user.getLinks().remove(Integer.parseInt(req.getParameter("removeLink")));
        ModelAndView mv;
        mv=new ModelAndView("user/registrationForm.html");
        mv.addObject("templates",resumeTemplateService.getTemplates());
        mv.addObject("user",user);
